...
export default function HomePage() {
  return (
    <div className="p-10 max-w-7xl mx-auto">
      ...
      <div className="p-10">
        <div className="bg-white border rounded-lg p-6 shadow-sm max-w-3xl mx-auto">
            <About
                title="About Me" 
    ...
    >
      ...
      <div className="flex justify-center gap-4">
        <a
          ...
          target="_blank"
          className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition w-72 text-center"
        >
